...
class _ZakatPageState extends State<ZakatPage> {
  ...
  // ================================================================
  // 🔷 Ambil data harga emas dari GoldAPI + kurs USD/IDR
  // ================================================================
  Future<void> _fetchGoldPrice() async {
    ...
    try {
      ...
      // -------------------------------------------------------------
      // Ambil kurs USD → IDR dari open.er-api.com
      // -------------------------------------------------------------
      ...
      // -------------------------------------------------------------
      // Ambil harga emas per gram 24K dari GoldAPI.io
      // -------------------------------------------------------------
      final goldRes = await http.get(
        Uri.parse('https://www.goldapi.io/api/XAU/USD'),
        headers: {
          'x-access-token': 'goldapi-ea11r3smhk7xgsb-io',
    ...
    // -------------------------------------------------------------
    // Hitung nilai nisab (85 gram emas)
    // -------------------------------------------------------------
    setState(() {
      ...
      body: _isLoading
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  // ======================================================
                  // INFORMASI HARGA EMAS DUNIA + STATUS KONEKSI
                  // ======================================================
